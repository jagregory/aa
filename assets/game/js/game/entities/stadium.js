...
function Stadium() {
  ...
  this.entities.push(new Wall('wall-top',    width / 2, top,            width, 1           ));
  this.entities.push(new Wall('wall-bottom', width / 2, bottom,         width, 1           ));
  this.entities.push(new Wall('wall-left1',  left  + 2, height * 1.0/6, 1,     height / 2.5));
  this.entities.push(new Wall('wall-left2',  left  + 2, height * 4.9/6, 1,     height / 2.5));
  this.entities.push(new Wall('wall-right1', right - 2, height * 1.0/6, 1,     height / 2.5));
  this.entities.push(new Wall('wall-right2', right - 2, height * 4.9/6, 1,     height / 2.5));
